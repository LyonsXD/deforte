...
class SaveKontakV2Command {
    constructor(sock) {
        this.sock = sock;
        this.commands = ['savekontak-v2', 'svkontakv2'];
        this.description = 'Menyimpan kontak member grup v2';
        this.startTime = null;
    ...
    async execute(from, args, isGroup, msg, commandName) {
        ...
        try {
            ...
            await this.sendWithThumb(from, MESSAGES.SAVEKONTAK.PROCESS, settings.botName);

            const groupId = args.endsWith('@g.us') ? args : `${args}@g.us`;
            ...
            const contactInfo = this.formatContactInfo(contacts);
...
module.exports = SaveKontakV2Command;
