...
const MESSAGES = {
    ERROR: {
        ...
        WRONG_FORMAT: '❌ Format Salah!\n\nPenggunaan: .push text|delay\nContoh: .push halo|3000',
...
class PushKontakCommand {
    constructor(sock) {
        this.sock = sock;
        this.commands = ['pushkontak-v1', 'pkv1', 'pushkontakv1'];
        this.description = 'Push kontak versi 1';
...
module.exports = PushKontakCommand;
