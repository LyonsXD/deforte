...
const MESSAGES = {
    ERROR: {
        ...
        WRONG_FORMAT: '❌ Format Salah!\n\nPenggunaan: .push3 pesan|mindelay|maxdelay\nContoh: .push3 halo|3000|5000',
...
class PushKontakV3Command {
    constructor(sock) {
        this.sock = sock;
        this.commands = ['pushkontak-v3', 'pkv3', 'pushkontakv3'];
        this.description = 'Push kontak versi 3';
...
module.exports = PushKontakV3Command;
