...
const MESSAGES = {
    ERROR: {
        ...
        WRONG_FORMAT: '❌ Format Salah!\n\nPenggunaan: .push4 idgrup|pesan|mindelay|maxdelay\nContoh: .push4 1234567890@g.us|halo|3000|5000',
        INVALID_DELAY: '❌ Delay minimal 1000ms (1 detik) dan maxdelay harus lebih besar dari mindelay!',
        INVALID_GROUP: '❌ ID grup tidak valid, harus diakhiri dengan @g.us',
        FAILED: '❌ Gagal melakukan push:\n{error}'
    },
    PUSH: {
        STARTED: '*Push Started*\n\n*Grup:* {group}\n*Total:* {total} member\n*Delay:* {minDelay}-{maxDelay} detik\n*Estimasi:* {estimate}',
        PROGRESS: '*Push Progress*\n\n*Grup:* {group}\n*Progress:* {progress}%\n*Berhasil:* {success}\n*Gagal:* {failed}',
        COMPLETED: '*Push Completed*\n\n*Grup:* {group}\n*Berhasil:* {success}\n*Gagal:* {failed}\n*Total Waktu:* {duration}'
    }
};

class PushKontakV4Command {
    constructor(sock) {
        this.sock = sock;
        this.commands = ['pushkontak-v4', 'pkv4', 'pushkontakv4'];
        this.description = 'Push kontak versi 4';
...
module.exports = PushKontakV4Command;
